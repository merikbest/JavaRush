package Collections.level39.task3904;
...
Требования:
•	Метод numberOfPossibleAscents должен возвращать количество способов прохождения лестницы из n ступенек.
•	Метод numberOfPossibleAscents должен возвращать 1 для n = 0.
•	Метод numberOfPossibleAscents должен возвращать 0 для n < 0.
•	Время выполнения метода numberOfPossibleAscents должно быть линейным.
*/
