package Collections.level36.task3603;
...
Требования:
•	Метод main должен создавать объект потокобезопасного аналога ArrayList, соответствующего заданию.
•	Метод main, после создания списка правильного типа, должен вызвать метод, который добавит в текущий список 'list' только те элементы переданной коллекции, которые не содержатся в 'list'.
•	Программа должна вывести 4 строки: "A C B D".
•	Программа не должна содержать слова "ClassNameToBeReplaced" и "methodNameToBeReplaced".
*/
