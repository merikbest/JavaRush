package Collections.level35.task3511;
...
Требования:
•	Для типа параметра метода sum(List list) нужно добавить подходящий шаблон (wildcard).
•	Для типа параметра метода multiply(List list) нужно добавить подходящий шаблон (wildcard).
•	Для типа параметра метода concat(List list) нужно добавить подходящий шаблон (wildcard).
•	Для типа параметра метода combine(List list) нужно добавить подходящий шаблон (wildcard).
*/
