package Collections.level34.task3411;
...
Требования:
•	В классе Solution должен существовать публичный статический метод void moveRing(char, char, char, int).
•	Методе moveRing должен быть рекурсивным.
•	Количество действий по перемещению колец должно быть равно 2 в степени numRings минус 1.
•	Вывод метода moveRing должен соответствовать условию.
*/
